...
if tr then
	toolranks.add_tool("emeralds:emerald_sword")
	toolranks.add_tool("emeralds:emerald_pickaxe")
	toolranks.add_tool("emeralds:emerald_axe")
	toolranks.add_tool("emeralds:emerald_shovel")
end
